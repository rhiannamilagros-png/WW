-- TAB ICON ALIGNMENT FIX: vertically centered 16x16 icon with balanced text spacing.
...
function ScoopHub_Library:CreateWindow(Config)
	...
	function Tabs:CreateTab(Config)
		...
		-- Even when a tab has no icon yet, the text stays aligned with
		-- icon-based tabs instead of moving all the way to the left.

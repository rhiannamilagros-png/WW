...
local Library={Unloaded=false,Build="SCOOPHUB_PREMIUM_OPTION2_BRANDED_HEADER_FIXED_BORDER_ROUNDED_HEADER"}
...
local W,H=690,445
local HEADER,SIDE,GAP=48,132,8
...
function Library:CreateWindow(cfg)
 ...
 -- ScoopHub Premium / refined branded header
 ...
 -- Rounded header background so the dark fill follows the top corners too.
 local HeaderBack=C(N("Frame",{
  Name="ScoopHubHeaderBack",
 ...
 -- Fill the lower part so only the top reads as rounded.
 N("Frame",{
  Name="ScoopHubHeaderBottomFill",
 ...
 -- Keep the brand as separate labels so spacing is exact.
 ...
 BrandPremium.Name="ScoopHubBrandPremium"
 BrandPremium.ZIndex=52

 local VersionPill=C(N("Frame",{
  Name="ScoopHubVersionPill",
  Position=UDim2.new(0,0,0,7),
  Size=UDim2.fromOffset(42,18),
  BackgroundColor3=Color3.fromRGB(24,19,22),
  BackgroundTransparency=.02,
  BorderSizePixel=0,
  ZIndex=52
 },Header),9)
 S(VersionPill,T.Red,.50,1)
 ...
 local BrandVersion=label(
  ...
  UDim2.fromScale(1,1),
  9,
  Color3.fromRGB(222,217,220),
  T.Font,
  Enum.TextXAlignment.Center
 )
 BrandVersion.ZIndex=53

 local function alignBranding()
  local primaryWidth=math.max(BrandPrimary.TextBounds.X,76)

  BrandPremium.Position=UDim2.new(
   0,
   BrandPrimary.Position.X.Offset+primaryWidth+5,
   0,
   7
  )

  local premiumWidth=math.max(BrandPremium.TextBounds.X,63)

  VersionPill.Position=UDim2.new(
   0,
 ...
 own(BrandPrimary:GetPropertyChangedSignal("TextBounds"):Connect(alignBranding))
 own(BrandPremium:GetPropertyChangedSignal("TextBounds"):Connect(alignBranding))
 task.defer(alignBranding)

 local BrandByline=label(
  Header,
  tostring(cfg.Byline or cfg.Subtitle or "By Scoop"),
  UDim2.new(0,58,0,28),
  UDim2.fromOffset(132,13),
  9,
  Color3.fromRGB(145,145,154),
  T.Body
 )
 ...
 -- Smaller, quieter Discord pill so branding stays dominant.
 local DiscordPill=C(N("Frame",{
  Name="DiscordPill",
  AnchorPoint=Vector2.new(.5,.5),
  Position=UDim2.new(.62,0,.5,0),
  Size=UDim2.fromOffset(168,24),
  BackgroundColor3=Color3.fromRGB(29,22,26),
  BackgroundTransparency=.04,
  BorderSizePixel=0,
  ClipsDescendants=true,
  ZIndex=52
 },Header),12)
 S(DiscordPill,T.Line,.42,1)

 N("ImageLabel",{
  Name="DiscordIcon",
  Image=cfg.DiscordIcon or "rbxassetid://94434236999817",
  ImageColor3=Color3.fromRGB(192,186,245),
  ScaleType=Enum.ScaleType.Fit,
  BackgroundTransparency=1,
  BorderSizePixel=0,
 ...
 local Min=C(N("TextButton",{
  Text="-",
  Position=UDim2.new(1,-65,.5,-13),
  Size=UDim2.fromOffset(26,26),
  BackgroundColor3=Color3.fromRGB(27,20,23),
  BackgroundTransparency=.02,
  TextColor3=T.White,
  Font=T.Font,
  TextSize=15,

...
function Library:CreateWindow(config)
    ...
    function window:AddTab(tabConfig)
        ...
        function tab:AddUserDashboard(dashboardConfig)
            ...
            -- This dashboard owns the whole page so it does not waste the
            -- 24px generic tab-title strip used by ordinary tabs.
            ...
            local function preferenceToggle(
                title,
                description,
                y,
                settingKey,

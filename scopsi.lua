...
function Library:CreateWindow(cfg)
 ...
 BrandVersion.TextStrokeColor3=Color3.fromRGB(245,245,248)
 BrandVersion.TextStrokeTransparency=.58
 ...
 function window:AddTab(c)
  ...
  function tab:AddUserDashboard(u)
   ...
   local function card(pos,size,title)
    ...
    S(f,T.Red,.38,1);label(f,title,UDim2.new(0,12,0,8),UDim2.new(1,-24,0,18),11,T.Red,T.Font);return f
   end

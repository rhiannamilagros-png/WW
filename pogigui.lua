...
local Library={Unloaded=false,Build="SCOOPHUB_V2_2_LOGO_RED_THEME_ANTI_AFK"}

local T={
 Bg=Color3.fromRGB(9,5,8),Panel=Color3.fromRGB(22,10,14),
 Line=Color3.fromRGB(232,38,66),Red=Color3.fromRGB(255,18,52),
 RedDark=Color3.fromRGB(136,16,35),Text=Color3.fromRGB(255,92,116),
 Dim=Color3.fromRGB(211,66,88),White=Color3.fromRGB(246,244,252),
 ...
 Surface3=Color3.fromRGB(52,31,37),Stroke=Color3.fromRGB(218,44,70),
...
local USER_SOFT=Color3.fromRGB(122,74,84)
local USER_BUTTON=Color3.fromRGB(60,13,19)
local USER_BUTTON_HOVER=Color3.fromRGB(86,18,26)
...
function Library:CreateWindow(cfg)
 ...
 label(Header,cfg.Title or "SCOOPHUB",UDim2.new(0,40,0,5),UDim2.fromOffset(82,16),14,T.Red,T.Font)
 ...
 N("Frame",{Position=UDim2.new(0,8,0,HEADER),Size=UDim2.new(1,-16,0,1),BackgroundColor3=T.Stroke,BackgroundTransparency=.30,BorderSizePixel=0},Main)

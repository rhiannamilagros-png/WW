 ...
 function window:AddTab(c)
  ...
  function tab:AddUserDashboard(u)
   ...
   local function row(par,t,v,y)
    label(par,t,UDim2.new(0,12,0,y),UDim2.new(.42,-6,0,17),11,T.Muted,T.Body)
    local x=label(par,v,UDim2.new(.42,0,0,y),UDim2.new(.58,-12,0,17),11,T.White,T.Body,Enum.TextXAlignment.Right)
   ...
   local function tog(par,t,d,y,init,cb)
    ...
    if d and d~="" then label(par,d,UDim2.new(0,12,0,y+14),UDim2.new(1,-75,0,14),9,T.Muted,T.Body)end
